...
public void agregarCompraYDetalles(Compras compra, List<DetalleCompra> detalles) {
    ...
    try {
        ...
        parametroCompra = cn.conexionBD.prepareStatement(queryCompra, PreparedStatement.RETURN_GENERATED_KEYS);
...
public void actualizarCompraYDetalles(Compras compra, List<DetalleCompra> detalles) {
    ...
    try {
        ...
        parametroCompra = cn.conexionBD.prepareStatement(queryCompra);
